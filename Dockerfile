...
ARG NEXT_PUBLIC_TENANT_SUBDOMAIN
# Dokploy expone la variable como RECAPTCHA_SITE_KEY (sin prefijo). La recibimos
# y la mapeamos a NEXT_PUBLIC_RECAPTCHA_SITE_KEY para que Next.js la incruste en
# el bundle del cliente durante el build.
